...
--
-- docker compose exec oracle sqlplus SYS/p@FREEPDB1 as SYSDBA '@/sql/create-user-tablespace-kunde.sql'
-- docker compose exec oracle sqlplus kunde/p@FREEPDB1 '@/sql/create-schema-kunde.sql'
-- docker compose exec oracle sqlplus kunde/p@FREEPDB1 '@/sql/V1.0__Create.sql'
-- docker compose exec oracle sqlplus kunde/p@FREEPDB1 '@/sql/V1.1__Insert.sql'
--
