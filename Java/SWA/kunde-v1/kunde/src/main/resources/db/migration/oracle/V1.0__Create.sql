...
-- docker compose exec oracle sqlplus kunde/p@FREEPDB1 '@/sql/...'

-- Flyway unterstuetzt noch nicht Oracle 23 https://documentation.red-gate.com/fd/oracle-184127602.html
...
CREATE TABLE login (
    ...
    id       CHAR(36) PRIMARY KEY CONSTRAINT login_id CHECK (REGEXP_LIKE(id, '^[0-9a-f]{8}-([0-9a-f]{4}-){3}[0-9a-f]{12}$')),
