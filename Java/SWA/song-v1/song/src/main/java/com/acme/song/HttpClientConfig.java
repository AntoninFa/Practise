...
/**
 * Beans für die REST-Schnittstelle zu "interpret" (WebClient) und für die GraphQL-Schnittstelle zu "interpret"
 * (HttpGraphQlClient).
 *
...
interface HttpClientConfig {
    ...
    @Bean
    default InterpretRestRepository interpretRestRepository(final WebClient builder) {
        ...
        final var proxyFactory = HttpServiceProxyFactory
            ...
            .build();
        return proxyFactory.createClient(InterpretRestRepository.class);
    }
