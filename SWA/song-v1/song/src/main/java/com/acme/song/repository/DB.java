 ...
 */
@SuppressWarnings({"UtilityClassCanBeEnum", "UtilityClass", "MagicNumber", "RedundantSuppression", "unused"})
    ...
    private static List<Song> getSongs() {
        return Stream.of(
            Song.builder()
                ...
                .songGenre(List.of(GenreType.RAP, GenreType.DISCO))
            ...
            Song.builder()
                ...
                .songGenre(List.of(GenreType.POP, GenreType.DANCEPOP))
            ...
            Song.builder()
                ...
                .songGenre(List.of(GenreType.PUNKROCK))
            ...
            Song.builder()
                ...
                .songGenre(List.of(GenreType.FOLK))
            ...
            Song.builder()
                ...
                .songGenre(List.of(GenreType.NEUEDEUTSCHEWELLE, GenreType.POP))
