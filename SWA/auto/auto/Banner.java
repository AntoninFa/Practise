...
final class Banner {
    ...
    private static final String SERVICE_HOST = System.getenv("AUTO_SERVICE_HOST");
    private static final String SERVICE_PORT = System.getenv("AUTO_SERVICE_PORT");
    private static final String KUBERNETES = SERVICE_HOST == null
        ? "N/A"
        : "AUTO_SERVICE_HOST=" + SERVICE_HOST + ", AUTO_SERVICE_PORT=" + SERVICE_PORT;
