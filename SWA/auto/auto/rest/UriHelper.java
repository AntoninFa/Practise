...
class UriHelper {
    ...
    private static final String AUTOS_PREFIX = "/autos";
    ...
    private URI getBaseUriForwarded(final HttpServletRequest request, final String forwardedHost) {
        ...
        // x-forwarded-prefix: null bei Kubernetes Ingress Controller bzw. "/autos" bei Spring Cloud Gateway
        if (forwardedPrefix == null) {
            log.trace("getBaseUriForwarded: Kein \"" + X_FORWARDED_PREFIX + "\" im Header");
            forwardedPrefix = AUTOS_PREFIX;
        }
