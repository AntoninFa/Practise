...
internal class Program
{
    ...
    private static void ExceptionOn(bool condition)
    {
        if (condition)
            throw new Exception();
    }
    ...
    private static void PersonVergleichen(Person person, string name, string straßenname, int hausnummer)
    {
    ...
    private static void PersonDrucken(Person person)
    {
    ...
    private static void Main()
    {
        ...
        var straße1 = new Straße("General Graf von Doppelwumms-Platz");
        var straße2 = new Straße("Blumendorfer Landstraße");

        var adresse1 = new Adresse(straße1, 2);
        var adresse2 = new Adresse(straße1, 3);
        var adresse3 = new Adresse(straße2, 4);
        ...
        var straße1Kopie = new Straße(straße1);
        ...
        var teststraße = new Straße("Name");
        try
        {
        ...
        var testadresse = new Adresse(teststraße, 1);
        try
        {
